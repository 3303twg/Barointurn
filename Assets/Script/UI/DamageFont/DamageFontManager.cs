...
public class DamageFontManager : MonoBehaviour
{
    ...
    public int poolCnt = 30;
    private void Awake()
    {
        ObjectPoolManager.CreatePool(damageTextPrefab.name, damageTextPrefab, poolCnt, worldCanvas.transform);
    }
